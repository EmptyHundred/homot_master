...
Script *HMScriptLanguage::create_script() const {
	// Delegate to GDScript since HMScript is a wrapper around it
	return GDScriptLanguage::get_singleton()->create_script();
}
